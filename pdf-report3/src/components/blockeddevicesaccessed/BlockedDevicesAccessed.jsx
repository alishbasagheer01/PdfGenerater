...
import style from "./BlockedDevicesAccessedStyles.jsx";
const data = [
  { group: "No data to display", devices: "    ", description: "    ",date:"   " },
  
];
const BlockedDevicesAccessed= () => (
  <Document>
    <Page  size="A4" style={style.page}>
      <View style={style.navbar}>
      <Text style={style.leftcont}>
        Blocked Devices Accessed(Computers)
      </Text>
...
{data.map((item, i) => (
  <View key={i} style={[style.tableRow, i % 2 === 0 ? style.evenRow : style.oddRow]}>
    <Text style={[style.tableCell, style.col0]}> </Text>   {/* non-breaking space */}
...
export default BlockedDevicesAccessed;
