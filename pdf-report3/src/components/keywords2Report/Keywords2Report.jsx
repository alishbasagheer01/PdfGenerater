...
import style from "./keywords2Styles";

const data = [
  { user: "google docs",url:"google.com", hits:"6" },
  
  
];

const Keywords2Report= () => (
  <Document>
    <Page  size="A4" style={style.page}>
      <View style={style.navbar}>
      <Text style={style.leftcont}>
       Keywords Searched by Hits (Users)
      </Text>
  ...
  <Text style={[style.tableCell, style.col3, style.headerCell]}>No of Hits</Text>
</View>
  ...
  {item.url}
    ...
    <Text style={[style.tableCell, style.col3]}>{item.hits}</Text>
  </View>
))}
...
export default Keywords2Report;
