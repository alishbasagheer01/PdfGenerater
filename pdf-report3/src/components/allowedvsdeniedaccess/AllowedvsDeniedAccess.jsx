...
import style from "./AllowedvsDeniedAccessStyles";
const data = [
  { group: "All Devices", devices: "Imaging Devices-Others", description: "Integrated Webcam",access:"Allowed" },
  { group: "Human Interface Devices", devices: "Keyboard/Mouse", description: "2.4G Mouse[1EA7_0066]",access:"Allowed" },
  { group: "Wireless Devices", devices: "WiFi", description: "Intel(R) Wireless-AC 9560 160MHz",access:"Allowed" },
  
];
const AllowedvsDeniedAccess= () => (
  <Document>
    <Page  size="A4" style={style.page}>
      <View style={style.navbar}>
      <Text style={style.leftcont}>
        Allowed vs. Denied Access(Computers)
      </Text>
...
<View style={style.tableRow}>
  ...
  <Text style={[style.tableCell, style.col4, style.headerCell]}>Access</Text>
</View>
...
{data.map((item, i) => (
  <View key={i} style={[style.tableRow, i % 2 === 0 ? style.evenRow : style.oddRow]}>
    ...
    <Text style={[style.tableCell, style.col4,{color:"green"}]}>{item.access}</Text>
  </View>
))}
...
export default AllowedvsDeniedAccess;
