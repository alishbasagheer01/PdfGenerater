            ...
            <Page size="A4" style={ChatStyle.page}>
                ...
                <View style={ChatStyle.table}>
                    <View style={ChatStyle.tableHeader}>
                        ...
                        <Text style={{marginLeft:50,fontSize:12,paddintop:10}}>Active Time</Text>
                        <Text style={{marginLeft:50,paddingRight:10,fontSize:12,paddintop:10}}>Hits</Text>
                    </View>
                    {data.map((row, i) => (
                        <View style={ChatStyle.tableRow} key={i}>
                            <Text style={[ChatStyle.cell, { flex: 2, color: 'blue',  }]}>{row.user}</Text>
                            <Text style={{marginRight:15,fontWeight:10,fontSize:12,paddintop:10}}>{row.activeTime}</Text>
                            <Text style={{marginLeft:50,paddingRight:10,fontWeight:10,fontSize:12,paddintop:10}}>{row.hits}</Text>
                        </View>
                    ))}
                </View>
